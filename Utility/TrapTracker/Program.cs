...
using TargetSelector = PortAIO.TSManager; namespace AntiTrap
{
    class Program
    {
        ...
        {
            Config = MainMenu.AddMenu("Trap Tracker", "AntiTrap");
            Config.Add("Jinxe", new CheckBox("Jinx E"));
            Config.Add("caitw", new CheckBox("Caitlyn W"));
            Config.Add("teemor", new CheckBox("Teemo R"));
            Config.Add("Draw", new CheckBox("Draw"));
