...
using TargetSelector = PortAIO.TSManager; namespace EvadeSharp
{
    ...
    public class Skillshot
    {
        ...
        public bool Evade()
        {
            ...
            if (!getCheckBoxItem(Config.skillShots, "IsDangerous" + SpellData.MenuItemName) && getKeyBindItem(Config.Menu, "OnlyDangerous"))
            {
                _cachedValue = false;
            ...
            _cachedValue = getCheckBoxItem(Config.skillShots, "Enabled" + SpellData.MenuItemName);
            _cachedValueTick = Utils.TickCount;
        ...
        public void Game_OnGameUpdate()
        {
            ...
            if (SpellData.CollisionObjects.Count() > 0 && SpellData.CollisionObjects != null &&
                Utils.TickCount - _lastCollisionCalc > 50 && getCheckBoxItem(Config.collision, "EnableCollision"))
            {
        ...
        {
            if (!getCheckBoxItem(Config.skillShots, "Draw" + SpellData.MenuItemName))
            {
                return;
            }
