...
using TargetSelector = PortAIO.TSManager; namespace xSLx_Orbwalker
{
    ...
    public class xSLxOrbwalker
    {
        ...
        public static void AddToMenu()
        {
            ...
            Menu = MainMenu.AddMenu("Orbwalker", "LSORABSD");

            menuDrawing = Menu.AddSubMenu("Drawing", "orb_Draw");
            menuDrawing.Add("orb_Draw_AARange", new CheckBox("AA Circle"));//.SetValue(new Circle(true, Color.FloralWhite)));
            menuDrawing.Add("orb_Draw_AARange_Enemy", new CheckBox("AA Circle Enemy"));//.SetValue(new Circle(true, Color.Pink)));
            menuDrawing.Add("orb_Draw_Holdzone", new CheckBox("Holdzone"));//.SetValue(new Circle(true, Color.FloralWhite)));
            menuDrawing.Add("orb_Draw_MinionHPBar", new CheckBox("Minion HPBar"));//.SetValue(new Circle(true, Color.Black)));
            menuDrawing.Add("orb_Draw_MinionHPBar_thickness", new Slider("^ HPBar Thickness", 1, 1, 3));
            menuDrawing.Add("orb_Draw_hitbox", new CheckBox("Show HitBoxes"));//.SetValue(new Circle(true, Color.FloralWhite)));
            menuDrawing.Add("orb_Draw_Lasthit", new CheckBox("Minion Lasthit"));//.SetValue(new Circle(true, Color.Lime)));
            menuDrawing.Add("orb_Draw_nearKill", new CheckBox("Minion nearKill"));//.SetValue(new Circle(true, Color.Gold)));

            menuMisc = Menu.AddSubMenu("Misc", "orb_Misc");
            menuMisc.Add("orb_Misc_Holdzone", new Slider("Hold Position", 50, 0, 100));
            menuMisc.Add("orb_Misc_Farmdelay", new Slider("Farm Delay", 0, 0, 200));
            menuMisc.Add("orb_Misc_ExtraWindUp", new Slider("Extra Winduptime", 80, 0, 200));
            menuMisc.Add("orb_Misc_AutoWindUp", new CheckBox("Autoset Windup", false));
            menuMisc.Add("orb_Misc_Priority_Unit", new ComboBox("Priority Unit", 0, "Minion", "Hero"));
            menuMisc.Add("orb_Misc_Humanizer", new Slider("Humanizer Delay", 80, 15, 200));
            menuMisc.Add("orb_Misc_AllMovementDisabled", new CheckBox("Disable All Movement", false));
            menuMisc.Add("orb_Misc_AllAttackDisabled", new CheckBox("Disable All Attacks", false));

            menuMelee = Menu.AddSubMenu("Melee", "orb_Melee");
            menuMelee.Add("orb_Melee_Prediction", new CheckBox("Movement Prediction", false));

            modeCombo = Menu.AddSubMenu("Combo", "orb_Modes_Combo");
            modeCombo.Add("Combo_Key", new KeyBind("Key", false, KeyBind.BindTypes.HoldActive, 32));
            modeCombo.Add("Combo_move", new CheckBox("Movement"));
            modeCombo.Add("Combo_attack", new CheckBox("Attack"));

            modeHarass = Menu.AddSubMenu("Harass", "orb_Modes_Harass");
            modeHarass.Add("Harass_Key", new KeyBind("Key", false, KeyBind.BindTypes.HoldActive, 'C'));
            modeHarass.Add("Harass_move", new CheckBox("Movement"));
            modeHarass.Add("Harass_attack", new CheckBox("Attack"));
            modeHarass.Add("Harass_Lasthit", new CheckBox("Lasthit Minions"));

            modeLaneClear = Menu.AddSubMenu("LaneClear", "orb_Modes_LaneClear");
            modeLaneClear.Add("LaneClear_Key", new KeyBind("Key", false, KeyBind.BindTypes.HoldActive, 'V'));
            modeLaneClear.Add("LaneClear_move", new CheckBox("Movement"));
            modeLaneClear.Add("LaneClear_attack", new CheckBox("Attack"));

            modeLaneFreeze = Menu.AddSubMenu("LaneFreeze", "orb_Modes_LaneFreeze");
            modeLaneFreeze.Add("LaneFreeze_Key", new KeyBind("Key", false, KeyBind.BindTypes.HoldActive, 'Z'));
            modeLaneFreeze.Add("LaneFreeze_move", new CheckBox("Movement"));
            modeLaneFreeze.Add("LaneFreeze_attack", new CheckBox("Attack"));

            modeLasthit = Menu.AddSubMenu("LastHit", "orb_Modes_LastHit");
            modeLasthit.Add("LastHit_Key", new KeyBind("Key", false, KeyBind.BindTypes.HoldActive, 'X'));
            modeLasthit.Add("LastHit_move", new CheckBox("Movement"));
            modeLasthit.Add("LastHit_attack", new CheckBox("Attack"));

            modeFlee = Menu.AddSubMenu("Flee", "orb_Modes_Flee");
            modeFlee.Add("Flee_Key", new KeyBind("Key", false, KeyBind.BindTypes.HoldActive, 'A'));
