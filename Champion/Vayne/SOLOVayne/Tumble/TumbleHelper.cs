 ...
 namespace SoloVayne.Skills.Tumble
{
    internal class TumbleHelper
    {
        ...
        public static AIHeroClient GetClosestEnemy(Vector3 from)
        {
            ...
            {
                var owAI = TargetSelector.SelectedTarget;
        ...
        {
            var closeEnemies =
                LS.HeroManager.Enemies.FindAll(
                    en =>
                ...
                var enemies =
                    LS.HeroManager.Enemies.Where(
                        en =>
                            ...
                            ObjectManager.Player.GetSpellDamage(en, SpellSlot.Q)).ToList();
