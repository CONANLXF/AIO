    ...
    internal class Menus
    {
        ...
        public static void Initialize()
        {
            ...
            Vars.QMenu = Vars.Menu.AddSubMenu("Use Q to:");
            {
                ...
                Vars.QMenu.Add("harass", new Slider("Harass / If Health >= x%", 50, 0, 101));
                Vars.QMenu.Add("clear", new Slider("Clear / If Health >= x%", 50, 0, 101));
            }
            ...
            {
                Vars.WMenu.Add("combo", new Slider("Combo / If Health >= x%", 20, 0, 101));
                Vars.WMenu.Add("clear", new Slider("Clear / If Health >= x%", 25, 0, 101));
            }
            ...
            Vars.EMenu = Vars.Menu.AddSubMenu("Use E to:");
            {
                ...
                Vars.EMenu.Add("buildings", new Slider("Buildings / If Health >= x%", 50, 0, 101));
                Vars.EMenu.Add("jungleclear", new Slider("JungleClear / If Health >= x%", 50, 0, 101));
            }
