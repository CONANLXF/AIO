    ...
    internal static class ModeJungle
    {
        ...
        private static void ExecuteSimpleMode()
        {
            ...
            if (Q.CanCast(mob))
            {
                ...
                var useQBig = getBoxItem(MenuLocal, "Jungle.Simple.Q.Big");
                var useQSmall = getBoxItem(MenuLocal, "Jungle.Simple.Q.Small");
            ...
            if (W.IsReady() && getBoxItem(MenuLocal, "Jungle.Simple.W") != 0 && mob.LSIsValidTarget(Orbwalking.GetRealAutoAttackRange(null) + 65))
            {
                ...
                if (totalAa >= getBoxItem(MenuLocal, "Jungle.Simple.W") + 2 || CommonManaManager.GetMobType(mobs[0], CommonManaManager.FromMobClass.ByType) == CommonManaManager.MobTypes.Big)
                {
                    W.Cast();
                }
            }

            if (E.CanCast(mob) && getBoxItem(MenuLocal, "Jungle.Simple.E") != 0)
            {
                var useE = getBoxItem(MenuLocal, "Jungle.Simple.E");
