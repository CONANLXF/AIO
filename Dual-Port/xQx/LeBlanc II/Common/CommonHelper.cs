...
using TargetSelector = PortAIO.TSManager; namespace Leblanc.Common
{
    ...
    public static class CommonHelper
    {
        ...
        public static bool StillJumped(this Spell spell)
        {
            ...
            {
                return ObjectManager.Player.Spellbook.GetSpell(SpellSlot.W).Name.Equals("Leblancslidereturn", StringComparison.InvariantCultureIgnoreCase);
            }

            if (spell == Champion.PlayerSpells.W2)
            {
                return ObjectManager.Player.Spellbook.GetSpell(SpellSlot.R).Name.ToLower().Equals("Leblancslidereturnm", StringComparison.InvariantCultureIgnoreCase);
            }
