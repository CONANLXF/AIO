 ...
 namespace EvadeA
{
    internal class Program
    {
        ...
        public static void Init()
        {
            ...
            if (Helper.Debug && Helper.GetBool("Drawing.SS", YasuoMenu.DrawingsM))
            {
        ...
        private static void Game_OnOnGameUpdate(EventArgs args)
        {
            ...
            */
            ...
            if (Helper.GetBool("Evade.WSS", YasuoMenu.EvadeM))
            {
                YasuoEvade.Evade();
            }
            ...
            if (sender.Owner.IsValid && sender.Owner.IsMe)
            {
                ...
                if (Evading)
                {
                    ...
                    foreach (var skillshot in DetectedSkillshots)
                    {
                        ...
                        {
                            isDangerous = skillshot.GetValue("IsDangerous");
                            if (isDangerous)
                            {
                                break;
                            }
        ...
        private static void Drawing_OnDraw(EventArgs args)
        {
            ...
            {
                skillshot.Draw(
                    (Helper.GetBool("Evade.Enabled", YasuoMenu.EvadeM))
                        ? Color.DodgerBlue
