 ...
 namespace Syndra
{
    public static class OrbManager
    {
        ...
        static OrbManager()
        {
            Obj_AI_Base.OnPlayAnimation += Obj_AI_Base_OnPauseAnimation;
            Obj_AI_Base.OnProcessSpellCast += Obj_AI_Hero_OnProcessSpellCast;
        }

        static void Obj_AI_Base_OnPauseAnimation(Obj_AI_Base sender, GameObjectPlayAnimationEventArgs args)
        {
