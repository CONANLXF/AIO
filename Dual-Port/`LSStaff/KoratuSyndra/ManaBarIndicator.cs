...
using TargetSelector = PortAIO.TSManager; namespace Syndra
{
    ...
    internal static class ManaBarIndicator
    {
        ...
        internal static void Initialize()
        {
            ...
            Program.DrawMenu.Add("DrawManaBarIndicator", new CheckBox("Draw Combo ManaBar Indicator"));

            var manaBarItem = Program.DrawMenu["DrawManaBarIndicator"].Cast<CheckBox>().CurrentValue;
